    ...
    <div className='w-full flex gap-5 h-screen bg-zinc-900 p-20'>
        <div className='w-1/2 flex flex-col justify-between h-full  '>
            <div className="heading">
                ...
                <h1 className='text-[8vw] font-semibold uppercase -mb-5 leading-none '>OPENING</h1>
            </div>
        ...
        <div className='w-1/2'>
            <div className="heading">
                    ...
                    <div className="dets flex flex-col">
                        {["Instagram" , "Facebook" , "Linkedin" , "YOutube"].map((items,index)=>{
                            return(
                                <a href="" className='block text-xl mb-3 '>{items}</a>
                            )
                        })}
                    </div>
                </div>
